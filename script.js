...
const modeCopy = {
  fun: {
    ...
    'offer-card-copy-2': "Retainers made sense when a build took a year. Most don't anymore — once the ask is clear, weeks will do. So instead of asking you to trust a track record, I'll just show you the work. First 20M tokens, free. After that, you pay for what I use. That is the whole pricing page.",
    'offer-card-title-3': 'Tip if you want.',
    'offer-card-copy-3': "Or don't — a testimonial's worth more to me anyway. I keep the lessons, not your secrets. Your data stays yours. Pinky promise, but professional.",
